...
const IMAGE_POOL = {
  ...
  marketing: [
    { url: 'https://beoksolution.com/assets/blog/beok/seo-card.svg', alt: '비오케이솔루션 검색 노출 기본 세팅 카드', tags: ['SEO', '검색', '노출', '구글', '서치콘솔', '사이트맵', '색인', '메타', '마케팅'] },
    { url: 'https://beoksolution.com/assets/blog/beok/automation-card.svg', alt: '비오케이솔루션 예약 결제 알림 자동화 카드', tags: ['콘텐츠', '자동화', '예약', '결제', '알림톡', 'AI', '문의', '응대', '폼'] },
    { url: 'https://beoksolution.com/assets/blog/beok/workflow-card.svg', alt: '비오케이솔루션 홈페이지 운영 흐름 카드', tags: ['브랜딩', '캠페인', '전략', '홈페이지', '운영', '개선', '전환'] },
    { url: 'https://beoksolution.com/assets/blog/beok/checklist-card.svg', alt: '비오케이솔루션 홈페이지 운영 체크리스트 카드', tags: ['체크리스트', '준비', '주의', '필수', '방법', '단계', '확인', '운영'] },
  ...
  company: [
    { url: 'https://beoksolution.com/assets/blog/beok/workflow-card.svg', alt: '비오케이솔루션 홈페이지 운영 흐름 카드', tags: ['홈페이지', '제작', '운영', '관리', '문의', '개선', '서비스'] },
    { url: 'https://beoksolution.com/assets/blog/beok/seo-card.svg', alt: '비오케이솔루션 검색 노출 기본 세팅 카드', tags: ['SEO', '검색', '노출', '구글', '서치콘솔', '사이트맵', '메타'] },
    { url: 'https://beoksolution.com/assets/blog/beok/automation-card.svg', alt: '비오케이솔루션 예약 결제 알림 자동화 카드', tags: ['예약', '결제', '알림톡', 'AI', '자동화', '문의', '응대', '폼'] },
    { url: 'https://beoksolution.com/assets/blog/beok/checklist-card.svg', alt: '비오케이솔루션 홈페이지 운영 체크리스트 카드', tags: ['체크리스트', '준비', '주의', '필수', '방법', '단계', '확인', '운영'] },
