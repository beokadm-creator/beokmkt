...
def _expand_operational_keywords() -> None:
    ...
    homepage_flows = [
        ...
        "다국어 페이지 구성", "개인정보 동의와 수집 항목",
        "공지사항과 뉴스레터 발송", "채용 공고 관리",
    ]
    ...
    system_domains = [
        ...
        "권한 관리", "데이터 정산",
        "출입 통제", "수상·시상 관리", "부스·전시 배정",
        "설문·평가 수집", "인증서 발급", "예산 집행 관리",
    ]
    system_decisions = [
        ...
        "중복 데이터를 막는 검증 규칙", "대량 업로드와 일괄 수정 설계",
        "권한별 화면 노출 범위를 정하는 기준", "장애 발생 시 수동 처리 절차",
    ]
    ...
    conference_ops = [
        ...
        "초청장 발송", "숙박·교통 안내", "논문 심사 일정",
        "전시 부스 신청", "수료증 발급", "동시통역 신청",
    ]
    conference_contexts = [
    ...
    mice_events = [
        ...
        "해외 연자 초청 행사",
        "정책 토론회", "제품 론칭 행사", "학술 워크숍",
        "국제 심포지엄", "지자체 주최 행사", "온라인 웨비나",
    ]
    mice_services = [
