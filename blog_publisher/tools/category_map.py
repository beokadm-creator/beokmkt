...
_GRANULAR: dict[str, list[tuple[str, set[str]]]] = {
    ...
    "beok": [
        ...
        ("시스템개발", {"시스템", "관리자", "개발", "솔루션", "DB", "데이터", "연동", "셀프호스팅"}),
    ...
    # 서비스 쇼케이스 축 — 개발 사례 카테고리로 고정해 블로그 정체성을 유지한다.
    "racekra": [
        ("개발사례", {"공공데이터", "API", "PWA", "개발", "설계", "데이터", "서비스"}),
    ],
    "ncs": [
        ("개발사례", {"NCS", "Work24", "진단", "API", "개발", "설계", "데이터"}),
    ],
    # 쿠팡 파트너스 소비자 콘텐츠 — 회사 서비스 축과 분리된 전용 카테고리로 고정해
    # 블로그 목록/검색에서 B2B 글과 섞이지 않게 한다.
    "notebook_return": [
        ("반품노트북", {"반품", "리퍼", "노트북", "쿠팡", "시세", "재고", "등급", "중고"}),
    ],
}
