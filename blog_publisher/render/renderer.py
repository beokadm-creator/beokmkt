...
_SERVICE_PROOF = {
    ...
    "racekra": ("마분 서비스 구성 — 비오케이솔루션 개발 사례", [
    ...
    "ncs": ("NCS Passport 구성 — 비오케이솔루션 개발 사례", [
...
_OPERATION_FLOW = {
    ...
    "racekra": ("공공데이터 서비스 개발 흐름", "API 신청부터 운영 자동화까지 실제 개발 순서로 진행합니다", [
    ...
    "ncs": ("공공 API 서비스 개발 흐름", "여러 공공 API를 하나의 진단 흐름으로 묶어 구축합니다", [
