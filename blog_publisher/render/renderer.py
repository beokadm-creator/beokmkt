...
_SERVICE_PROOF = {
    ...
    "notebook_return": [
        ...
        ("반품 노트북 구매 체크 범위", [
            ("등급별 상태", "최상·상·중·리퍼 등급의 실제 상태 차이를 확인합니다."),
            ("가격 비교", "정가·반품가·동급 매물 시세를 함께 비교합니다."),
            ("보증 조건", "A/S 기간과 구성품 포함 여부를 확인합니다."),
            ("재고 변동", "반품 매물 특성상 재고가 자주 바뀌어 실시간 확인이 필요합니다."),
        ]),
    ],
    "racekra": [
        ...
        ("마분 서비스 구성 요소", [
            ("공공 데이터 수집", "경마 공공데이터 API로 출전·배당 정보를 가져옵니다."),
            ("설명 가능한 지표", "근거 데이터를 함께 보여주는 주목지수를 제공합니다."),
            ("무현금 미니게임", "현금 베팅 없는 응원권 방식으로 운영합니다."),
            ("설치 없는 접근", "모바일 웹 브라우저에서 바로 이용합니다."),
        ]),
    ],
    "ncs": [
        ...
        ("NCS Passport 서비스 구성", [
            ("역량 진단", "NCS 기준으로 현재 역량과 목표 직무 격차를 분석합니다."),
            ("훈련 연결", "국민내일배움카드 훈련과정 정보를 안내합니다."),
            ("채용 정보 통합", "채용행사·공채·자격증 정보를 함께 제공합니다."),
            ("이력 저장", "진단 결과를 저장해 재방문 시 비교합니다."),
        ]),
    ],
}
...
_OPERATION_FLOW = {
    ...
    "notebook_return": [
        ...
        ("반품 노트북 구매 순서", "용도 파악부터 재고 확인까지 순서대로 진행합니다", [
            ("용도·예산 설정", "사무용·게이밍 등 용도와 예산 범위를 정합니다."),
            ("등급·상태 확인", "등급 기준과 실제 상태 설명을 확인합니다."),
            ("시세 비교", "정가 대비 할인율과 동급 매물을 비교합니다."),
            ("구매 결정", "재고·배송·보증 조건 확인 후 결정합니다."),
        ]),
    ],
    "racekra": [
        ...
        ("공공데이터 서비스 구축 순서", "신청부터 자동화까지 개발 단계로 진행합니다", [
            ("API 신청", "공공데이터포털에서 활용 신청을 진행합니다."),
            ("데이터 검증", "실제 호출로 스키마와 갱신 주기를 확인합니다."),
            ("화면 구현", "수집 데이터를 사용자 화면으로 구성합니다."),
            ("자동화 적용", "키 갱신과 장애 감지를 자동화합니다."),
        ]),
    ],
    "ncs": [
        ...
        ("공공 API 연계 서비스 구축 순서", "API 선정부터 개선까지 이어지는 개발 흐름입니다", [
            ("API 선정", "필요한 공공 데이터 API를 선정합니다."),
            ("프록시 구성", "인증·에러 처리를 한곳에서 관리합니다."),
            ("진단 로직 설계", "기준에 맞춰 진단·추천 로직을 만듭니다."),
            ("데이터 기반 개선", "저장된 결과로 추천을 지속 개선합니다."),
        ]),
    ],
}
...
_OPS_COMPARISON = {
    ...
    "notebook_return": [
        ...
        ("반품 노트북 구매 체크 비교", ("항목", "확인 안 하면", "확인 후 구매"), [
            ("등급", "설명만 보고 구매", "실제 등급 기준과 대조"),
            ("가격", "정가만 확인", "동급 매물과 비교"),
            ("보증", "보증 여부 확인 안 함", "A/S·구성품 사전 확인"),
            ("재고", "오래된 정보 신뢰", "실시간 재고 재확인"),
        ]),
    ],
    "racekra": [
        ...
        ("공공데이터 서비스 리스크 비교", ("항목", "방치 시 리스크", "권장 기준"), [
            ("데이터 확보", "비공식 수집 리스크", "공공데이터 API 정식 신청"),
            ("데이터 최신성", "수동 갱신 누락", "자동 파이프라인 갱신"),
            ("지표 신뢰도", "근거 없는 수치 제공", "설명 가능한 지표 제공"),
            ("키 관리", "만료 방치", "자동 감지·갱신"),
        ]),
    ],
    "ncs": [
        ...
        ("공공 고용 API 서비스 리스크 비교", ("항목", "방치 시 리스크", "권장 기준"), [
            ("API 연동", "개별 호출 관리 어려움", "프록시 통합 관리"),
            ("장애 대응", "오류 시 빈 화면", "공식 링크 폴백"),
            ("추천 품질", "단순 나열", "진단 연동 추천"),
            ("이력 관리", "결과 미저장", "리포트 저장·재진단"),
        ]),
    ],
}
